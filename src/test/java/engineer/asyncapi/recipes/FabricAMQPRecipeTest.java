...
public class FabricAMQPRecipeTest {
  ...
  public void testChannelBindings() {
    ...
    AMQP091ChannelBinding020 binding = (AMQP091ChannelBinding020) bindings
        .get("amqpExampleChannelBinding");
  ...
  public void testMessageBindings() {
    ...
    AMQP091MessageBinding020 binding = (AMQP091MessageBinding020) bindings
        .get("amqpCommandMessageBinding");
    assertEquals("0.2.0", binding.getBindingVersion());
  ...
  public void testMessageTraits() {
    ...
    assertEquals(0,
        triat.getHeaders().getProperties().get("your-app-header").getMinimum().intValue());
    assertEquals(100,
        triat.getHeaders().getProperties().get("your-app-header").getMaximum().intValue());
  }
  ...
  public void testOperationBindings() {
    ...
    AMQP091OperationBinding020 binding = (AMQP091OperationBinding020) bindings
        .get("amqpExampleOperationBinding");
  ...
  public void testOperationTraits() {
    ...
    AMQP091OperationBinding020 binding = (AMQP091OperationBinding020) triats.get("yourTriatName")
        .getBindings();
    assertEquals("guest", binding.getUserId());
    assertEquals("0.2.0", binding.getBindingVersion());
  }
  ...
  public void testServerBindings() {
    ...
    AMQP091ServerBinding020 binding = (AMQP091ServerBinding020) bindings
        .get("amqpExampleServerBinding");
